...
data class RetrieveCachedTemplateModel(val status: Status, val templateDefinition: DSTemplateDefinition?, val position: Int, val exception: DSTemplateException?)
data class RemoveCachedTemplateModel(val status: Status, val templateDefinition: DSTemplateDefinition?, val position: Int, val exception: DSTemplateException?)
