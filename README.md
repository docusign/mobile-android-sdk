...
1.  In your application's root build.gradle file:
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:1.5.3.1'
            implementation 'com.docusign:sdk-common:1.5.3.1'
        }
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:1.5.3.1'
            implementation 'com.docusign:sdk-common:1.5.3.1'
            implementation 'com.docusign:sdk-offline-signing:1.5.3.1'
        }
    ```
    ...
    dependencies {
        implementation 'com.docusign:androidsdk:1.5.3.1'
        implementation 'com.docusign:sdk-common:1.5.3.1'
        implementation 'com.docusign:sdk-esign-api:1.5.3.1'
    }
    ```
