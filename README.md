...
1.  In your application's root build.gradle file:
    ...
    allprojects {
        repositories {
            ...
            maven {
                url  "https://docucdn-a.akamaihd.net/demo/docusignandroidsdk"
            }
        }
        }
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:1.7.3.1'
            implementation 'com.docusign:sdk-common:1.7.3.1'
        }
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:1.7.3.1'
            implementation 'com.docusign:sdk-common:1.7.3.1'
            implementation 'com.docusign:sdk-offline-signing:1.7.3.1'
        }
    ```
    ...
    dependencies {
        implementation 'com.docusign:androidsdk:1.7.3.1'
        implementation 'com.docusign:sdk-common:1.7.3.1'
        implementation 'com.docusign:sdk-esign-api:1.7.3.1'
    }
    ```
