...
1.  In your application's root build.gradle file:
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:1.7.5'
            implementation 'com.docusign:sdk-common:1.7.5'
        }
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:1.7.5'
            implementation 'com.docusign:sdk-common:1.7.5'
            implementation 'com.docusign:sdk-offline-signing:1.7.5'
        }
    ```
    ...
    dependencies {
        implementation 'com.docusign:androidsdk:1.7.5'
        implementation 'com.docusign:sdk-common:1.7.5'
        implementation 'com.docusign:sdk-esign-api:1.7.5'
    }
    ```
