...
1.  In your application's root build.gradle file:
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:2.1.5'
            implementation 'com.docusign:sdk-common:2.1.5'
        }
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:2.1.5'
            implementation 'com.docusign:sdk-common:2.1.5'
            implementation 'com.docusign:sdk-offline-signing:2.1.5'
        }
    ```
    ...
    dependencies {
        implementation 'com.docusign:androidsdk:2.1.5'
        implementation 'com.docusign:sdk-common:2.1.5'
        implementation 'com.docusign:sdk-esign-api:2.1.5'
    }
    ```
