...
1.  In your application's root build.gradle file:
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:1.9.0'
            implementation 'com.docusign:sdk-common:1.9.0'
        }
    ...
    ```gradle
        ...
        dependencies {
            implementation 'com.docusign:androidsdk:1.9.0'
            implementation 'com.docusign:sdk-common:1.9.0'
            implementation 'com.docusign:sdk-offline-signing:1.9.0'
        }
    ```
    ...
    dependencies {
        implementation 'com.docusign:androidsdk:1.9.0'
        implementation 'com.docusign:sdk-common:1.9.0'
        implementation 'com.docusign:sdk-esign-api:1.9.0'
    }
    ```
